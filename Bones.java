...
public class Bones extends JFrame implements ActionListener {
    ...
    public Bones(String[] var1) {
        ...
        ArrayList<String> var2 = this.processCmdLineArgs(var1);
    ...
    public ArrayList processCmdLineArgs(String[] var1) {
        ...
        for (String s : var1) {
            if (s.equalsIgnoreCase("human")) {
                ...
                this.victory = Integer.parseInt(s.substring(5));
            } else if (s.startsWith("speed=")) {
                this.speedOfPlay = Integer.parseInt(s.substring(6));
                this.flickerDelay = this.speedOfPlay / 5;
                var3 = true;
            } else if (s.endsWith(".class")) {
                var2.add(s.substring(0, s.length() - 6));
            } else {
                var2.add(s);
            }
        }
        ...
        if (var2.isEmpty()) {
            ...
            Collections.addAll(this.computerNames, var15);

            Collections.shuffle(this.computerNames);
            var2.add((String)this.computerNames.get(0));
            var2.add((String)this.computerNames.get(1));
            var2.add((String)this.computerNames.get(2));
            var2.add((String)this.computerNames.get(3));
            return var2;
    ...
    public void actionPerformed(ActionEvent var1) {
        ...
        if (var1.getSource() == this.quitButton) {
            ...
            if (this.preAttack) {
                assert var3 != null;
                if (var3.getOwner() == this.currentPlayer && var3.getDice() >= 2 && !this.board.getEnemyNeighbors(var3).isEmpty()) {
            ...
            if (this.tournament) {
                ...
                if (this.currentPlayer.getWins() == this.victory) {
                    ...
                    while(var10.hasNext()) {
                        ...
                        var10000 = System.out;
                        var10001 = var11.getWins();
                        var10000.println(var10001 + " wins for " + var11.getName());
                    }
                } else {
                    var10001 = this.qtyGames;
                    System.out.println("Game " + var10001 + " won by " + this.currentPlayer.getName() + ".");
                    ...
                    while(var10.hasNext()) {
                        ...
                        var10000.print(var12 + ": " + var11.getWins() + "  ");
                    }
    ...
    private void processAttack(Territory var1, Territory var2) {
        ...
        for(var9 = 0; var9 < var1.getDice(); ++var9) {
            var7 += (int)(Math.random() * 6.0 + 1.0);
        }

        for(var9 = 0; var9 < var2.getDice(); ++var9) {
            var8 += (int)(Math.random() * 6.0 + 1.0);
        }
        ...
        try {
            Thread.sleep((long)(2L * this.flickerDelay));
        } catch (Exception ignored) {
        }
    ...
    private ArrayList createPlayers(ArrayList<String> var1) {
        ArrayList var2 = new ArrayList();
            ...
            if (var7.equals("Human")) {
                ...
                try {
                    if (this.computerNames != null) {
                        ...
                        Object var9 = var11.loadClass(var7).getDeclaredConstructor().newInstance();
